...
!python train.py --dataroot ./datasets/facades --name facades --model cycle_gan --use_wandb --batch_size 16
...
!python test.py --dataroot datasets/horse2zebra/testA --name facades_pretrained --model test --no_dropout --use_wandb
